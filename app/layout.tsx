...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://cewekmandi.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Bocil Jepang Ngentot Jav Jilbab Smp Barat Mama Viral Sma Korea Tante China Live Paksa Bokep Abg Terbaru`,
        "logo": "https://cewekmandi.pages.dev/favicon.ico",
        "url": "https://cewekmandi.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://cewekmandi.pages.dev"
        ...
        "url": "https://cewekmandi.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Bocil Jepang Ngentot Jav Jilbab Smp Barat Mama Viral Sma Korea Tante China Live Paksa Bokep Abg Terbaru`,
        "image": "https://cewekmandi.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://cewekmandi.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://cewekmandi.pages.dev/?q={search_term}", 
